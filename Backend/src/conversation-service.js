...
async function generateCampaignReply(userId, campaignId, contactId, message) {
  ...
  2. If the documents mention a different event or year, still use that content to answer the question
  3. Do NOT mention internal sources, "campaign context", or say "based on the context"
  4. If the answer is not in the context, say you don't have that detail and ask one short follow-up
