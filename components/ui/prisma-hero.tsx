        ...
        <nav className="absolute left-0 right-0 top-0 z-20 px-4 md:px-10">
          <div className="flex items-center justify-between py-4 md:py-6">
            ...
            <div className="flex items-center gap-3 sm:gap-5">
              <Link href="/campaign/title" className="bg-[#E1E0CC] text-black px-4 py-2 rounded-full font-sans font-bold cursor-pointer hover:bg-[#E1E0CC]/90 transition-all text-sm sm:text-base">
                Start Campaign
              </Link>
            </div>
          </div>
