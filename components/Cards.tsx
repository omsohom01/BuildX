  ...
  const features = [
    {
      ...
      description:
        'Launch personalized campaigns across WhatsApp, Voice, and Calls with one unified workflow.',
    },
    {
      icon: <RiWechatChannelsLine className="text-white/80" />,
      title: 'RAG‑Powered AI Responses',
      description:
        'Upload your documents and let OutreachX answer customer queries with grounded, accurate AI using RAG.',
    },
    {
      icon: <FaWhatsapp className="text-white/80" />,
      title: 'AI‑Powered WhatsApp Conversations',
      description:
        'Contacts get instant, context-aware replies on WhatsApp powered by Gemini and LangGraph orchestration.',
    },
    {
      icon: <TbDeviceDesktopAnalytics className="text-white/80" />,
      title: 'Realtime Analytics',
      description:
        'Monitor delivery, engagement, and call metrics in real time to optimize campaign performance.',
    },
    {
      icon: <RiImageAddFill className="text-white/80" />,
      title: 'AI Voice Notes & Calls',
      description:
        'Generate voice notes (Gemini TTS) and make AI phone calls (VAPI) with natural-sounding audio.',
    },
    {
      icon: <MdAutoGraph className="text-white/80" />,
      title: 'Fast Onboarding & Compliance',
      description:
        'Get started quickly with onboarding flows and built‑in compliance reminders for messaging.',
    },
  ]
    ...
    <div className="w-full bg-black py-20 px-4 md:px-8 lg:px-16 mb-50">
      <div className="max-w-6xl mx-auto mb-16">
        <h2 className=" text-white/80 leading-none">
          <span className="block text-left text-xl md:text-4xl ml-5 font-instrument">
            Built for modern
          </span>
          <span className="block text-center text-6xl md:text-[20vh] font-instrument italic">
            Outreach.
          </span>
        </h2>
      </div>
            ...
            <div key={index} className="group relative" style={{ perspective: '1000px' }}>
              ...
              >
                ...
                <div className="relative z-10">
                  <h3 className="text-4xl text-white mb-3 font-instrument">{feature.title}</h3>
